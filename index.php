...
<section class="hero" id="home">
  ...
  <div class="hero-content">
    ...
    <section class="categories" id="categories">
        <div class="container">
            ...
            <div class="categories-grid">
                <!-- Categories with direct HTML instead of JS generation -->
    ...
    <script>
        // Override the populateCategories function to do nothing
        function populateCategories() {
            // Function overridden to do nothing since categories are in HTML now
            return;
        }
    </script>
</body>
